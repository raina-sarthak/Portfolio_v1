export default function Hero(){
    return(
        ...
        <div class="h-screen bg-cover bg-[url(https://cdn.muscleandstrength.com/sites/default/files/field/feature-wide-image/workout/dumbbell_bodyweight_workout_-_1000x500.jpg)] bg-no-repeat">
                ...
                <div class="max-w-3xl text-center mx-auto">
                    ...
                    Now it's easier than ever to build your dream physique!
                    </h1>
                </div>
                

                <div class="max-w-3xl text-center mx-auto">
                    <p class="text-lg text-gray-400">This is a collection of top workout programs, from top athelets accross the world.</p>
                </div>
